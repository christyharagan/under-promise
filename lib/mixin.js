 ...
 * @param all - a function that takes an array of promises and returns a new promise that resolves if all promises in the array resolve, and fails if any of them fail.
 * @param {boolean} newInstance
 * @returns {*}
 */
module.exports = function (_, all, newInstance) {
  if (newInstance) {
    _ = _.runInContext();
  }
